...
function Selectable({ children }) {
  ...
  return (
    <div
      className={`relative w-full min-h-[24px] rounded-sm transition-all duration-300 ease-linear flex align-baseline group ${bgColor} ${color} ${borderColor} mb-3`}
    >
      <div className="absolute -translate-x-[2.6rem] p-1 cursor-pointer grid place-items-center hover:bg-white/5 rounded-sm opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-opacity duration-200 ease-linear">
        <svg
          viewBox="0 0 16 16"
      ...
      <Dropdown overlay={menu} trigger={"click"}>
        <div
          className="absolute -translate-x-[1.2rem] w-[18px] h-6 cursor-pointer grid place-items-center hover:bg-white/5 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-opacity duration-200 ease-linear"
          onClick={select}
        >
          <svg
            viewBox="0 0 10 10"
