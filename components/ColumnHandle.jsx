...
function ColumnHandle() {
  ...
  return (
    <Dropdown overlay={menu} placement={"bottom"} trigger={'click'}>
      <div className="absolute -top-2 left-1/2 -translate-x-1/2 w-6 h-4 px-1 py-[2px] rounded cursor-pointer grid place-items-center bg-[#373737] opacity-0 transition-all duration-300 ease-linear hover:opacity-100">
        <svg
          viewBox="0 0 10 10"
          className="w-[26px] h-4 block shrink-0 rotate-90 fill-white"
        >
